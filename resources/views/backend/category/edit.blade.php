                        ...
                        <form id="categoryForm" class="content_form" action="{{ route('admin.category.update',$category->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-6">
                                    <label for="meta_keyword" class="form-label">Meta Keyword <span class="text-danger"> Use
                                            Comma " , " *</span></label>
                                    <input type="text" name="meta_keyword" value="{{$category->meta_keyword}}" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="text" name="meta_article_tag" value="{{$category->meta_article_tag}}" class="form-control">
                                </div>
                                <div class="mb-3 col-6">
                                    <label for="meta_script_tag" class="form-label">Meta Script Tag <span
                                            class="text-danger"> Use Comma " , "</span></label>
                                    <input type="text" name="meta_script_tag" value="{{$category->meta_script_tag}}" class="form-control">
                                </div>
                            </div>
